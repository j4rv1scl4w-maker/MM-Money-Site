    ...
    <div>
      ...
      {featured && (
        <div style={{ padding: '0 56px 36px' }}>
          <Link href={`/articles/${featured.slug}`} style={{ textDecoration: 'none', color: 'inherit', display: 'grid', gridTemplateColumns: '1.15fr 1fr', background: 'var(--bg2)', border: '1px solid var(--line)', borderRadius: 12, padding: 22, gap: 28, alignItems: 'center' }}>
